...
# Generated by qmake (2.01a) (Qt 4.8.5) on: ?? 6? 8 08:08:31 2018
# Project:  adt_aec.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/adt_aec1.0.0/ && $(COPY_FILE) --parents include/aecg4.h include/iaecg4.h .tmp/adt_aec1.0.0/ && $(COPY_FILE) --parents main.cpp .tmp/adt_aec1.0.0/ && (cd `dirname .tmp/adt_aec1.0.0` && $(TAR) adt_aec1.0.0.tar adt_aec1.0.0 && $(COMPRESS) adt_aec1.0.0.tar) && $(MOVE) `dirname .tmp/adt_aec1.0.0`/adt_aec1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/adt_aec1.0.0
...
install_target: first FORCE
	...
	-$(INSTALL_PROGRAM) /home/rudy/workspace_hd/GYT/ADT/adt_aec/adt_aec $(INSTALL_ROOT)/opt/aec/
